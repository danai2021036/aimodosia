        ...
        stage('Deploy frontend') {
            steps {
                sh '''
                   # sed -i 's/dbserver/51.13.41.31/g' ~/workspace/ansible-aimodosia/host_vars/appserver-vm.yaml
                    export ANSIBLE_CONFIG=~/workspace/ansible-aimodosia/ansible.cfg
                     ansible-playbook -i ~/workspace/ansible-aimodosia/hosts.yaml -l frontend-server -e frontendvm_ip=172.167.33.29 -e backendvm_ip=34.38.31.68 ~/workspace/ansible-aimodosia/playbooks/vuejs.yaml
